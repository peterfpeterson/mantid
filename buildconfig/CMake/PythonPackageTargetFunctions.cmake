...
function(add_python_package pkg_name)
  ...
  # set empty variable to put dependencies into
  set(_pkg_depends)
  ...
  if(NOT CONDA_BUILD)
    add_custom_command(
      ...
      COMMAND
        ...
        MANTID_VERSION_STR=${_version_str} ${Python_EXECUTABLE} -m pip install --editable . --ignore-installed --no-deps
      COMMAND ${CMAKE_COMMAND} -E touch ${_stamp}
      WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
      DEPENDS ${_setup_py}
      BYPRODUCTS ${_outputs}
    )
    set(_pkg_depends ${_pkg_depends} ${_stamp})
  endif()
  ...
  # add the pacakge to the ALL target
  ...
  python -m pip install ${CMAKE_CURRENT_SOURCE_DIR} --disable-pip-version-check --no-deps --no-cache-dir -vvv)"
            COMPONENT Runtime
    )
  endif()
